    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto bg-gray-900 bg-opacity-80 p-10 rounded-2xl shadow-2xl border border-gray-800 flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-6 leading-relaxed">
          I'm <span className="font-bold text-yellow-300">Astha Singh</span>, a Computer Science (AI/ML) student focused on building intelligent systems that solve real-world problems. My work revolves around designing efficient, scalable machine learning solutions with a strong emphasis on NLP and Generative AI.
        </p>

        <div className="text-left text-gray-300 space-y-3 mb-8">
          {[
            "I specialize in NLP and transformer-based models, working with embeddings, Hugging Face, and RAG architectures to build context-aware AI systems.",
            
            "I have hands-on experience developing end-to-end ML pipelines — from data preprocessing and feature engineering to model training, evaluation, and deployment.",
            
            "I focus heavily on optimization — improving model accuracy, reducing latency, and enhancing real-world usability through experimentation and tuning.",
            
            "My projects, including AI-driven detection and verification systems, demonstrate practical applications of ML in solving real-world challenges.",
            
            "I’m deeply interested in pushing AI systems beyond theory — building solutions that are efficient, reliable, and production-ready.",
          ].map((text, i) => (
