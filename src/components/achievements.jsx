...
const achievementsData = [
  ...
  {
    icon: <FaStar size={32} />,
    title: "Academic Excellence – Top Performer",
    description:
      "SGPA: 9.27 (1st Sem), 8.8 (2nd Sem), 8.6 (3rd Sem). Consistently among top academic performers.",
  ...
  },
  {
    ...
    description:
      "Solved 100+ DSA problems with a 1686 platform rating, strengthening problem-solving skills.",
  ...
  },
  {
    ...
    description:
      "Published research on Federated Homomorphic Anomaly Detection (FHAD) for secure AI-driven systems. Submitted to LNCS.",
    bgColor: "from-indigo-500 to-indigo-700",
    category: "Curricular",
  },
  {
    icon: <FaBookOpen size={32} />,
    title: "Research Paper – ANALISTA",
    description:
      "Published work on ANALISTA framework focusing on intelligent data analysis and AI-driven interpretation systems.",
  ...
  // 🏆 HACKATHONS AND COMPETITIONS
  {
    ...
    title: "Winner – Engineer’s Day Innovation Challenge",
    description:
      "Won for proposing an AI-powered Toxic Comment Detection & Cyberbullying Prevention system using NLP and sentiment analysis.",
  ...
  },
  {
    ...
    description:
      "Selected among top semi-finalists in a national-level competitive tech challenge.",
  ...
  },
  {
    ...
    description:
      "Top 1% of 3000+ teams. Built an AI-driven solution in a high-pressure innovation environment.",
  ...
  },
  {
    ...
    description:
      "Secured 2nd position in Smart City innovation challenge with a real-world problem-solving solution.",
    bgColor: "from-purple-500 to-purple-700",
    category: "Hackathons and Competitions",
  },
  {
    icon: <FaTools size={32} />,
    title: "Model Designing Competition – Runner Up",
    description:
      "Designed a sensor-based railway accident prevention system using intelligent monitoring concepts.",
  ...
  },
  {
    ...
    description:
      "Regular participant in coding contests on platforms like GFG and Unstop.",
  ...
  // 🌟 EXTRACURRICULAR
  {
    ...
    title: "Organizer – Technical Events",
    description:
      "Coordinated hackathons, workshops, and technical seminars at the college level.",
  ...
  },
  {
    ...
    description:
      "Promoted civic engagement and digital awareness initiatives among students.",
  ...
  },
  {
    ...
    description:
      "Won 2nd prize in inter-college graffiti art competition.",
    bgColor: "from-fuchsia-500 to-fuchsia-700",
    category: "Extracurricular",
  },
  {
    icon: <FaUsers size={32} />,
    title: "Street Play Performer (Nukkad Natak)",
    description:
      "Participated in socially themed street plays addressing real-world issues.",
  ...
  },
  {
    ...
    description:
      "Secured runner-up position in inter-departmental turncoat debate competition.",
      ...
      <div ref={tabsRef} className="flex justify-center gap-4 mb-10 relative">
        {categories.map((cat) => (
          <button
            ...
            className={`relative px-5 py-2 rounded-full font-semibold transition-all border ${activeTab === cat
