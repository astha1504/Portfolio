  ...
  return (
    ...
    <div className="text-center mb-20 relative z-10">
      ...
      <p className="text-gray-400 max-w-2xl mx-auto text-lg">
        Dive into a collection of my latest projects...
      </p>
    ...
    <div className="text-center mb-16 relative z-10">
      <button
        ...
        className="px-8 py-3 bg-yellow-500 text-black font-semibold rounded-full shadow-lg hover:bg-yellow-400 transition-all duration-300 transform hover:scale-105 hover:shadow-yellow-500/50"
      >
        View All Projects →
      </button>
    </div>
